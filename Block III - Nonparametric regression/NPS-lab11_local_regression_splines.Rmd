...
computationally more efficient B-spline basis.
...
$$\#dof = \#breaks + degree$$ Example, if we want $4$ breaks and a cubic
...
Despite the considerable coding effort with respect to using the
...
natural spline basis (orthonormal), placing knots at all the inputs.
